...
const MobileHeaderLink: FC<{ item: HeaderItem }> = memo(({ item }) => {
  ...
  return (
    <div className="relative w-full">
      ...
      {submenuOpen && item.submenu && (
        <div className="bg-white dark:bg-darkmode p-2 w-full animate-in fade-in slide-in-from-top-1 duration-150">
...
MobileHeaderLink.displayName = 'MobileHeaderLink';
