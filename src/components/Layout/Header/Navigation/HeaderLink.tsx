...
const HeaderLink: FC<{ item: HeaderItem }> = memo(({ item }) => {
  ...
  return (
    ...
    >
      ...
      {submenuOpen && (
        <div className="absolute py-2 top-8 left-0 mt-0.5 w-60 bg-white dark:bg-darkmode shadow-lg dark:shadow-darkmd rounded-lg animate-in fade-in duration-150">
