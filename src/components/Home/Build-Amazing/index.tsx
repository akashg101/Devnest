          ...
          <div className='grid lg:grid-cols-2 grid-cols-1 items-center'>
            <div
              ...
              <h2 className='text-secondary dark:text-white max-w-420 pb-8'>
                Crafting Beautiful Digital Experiences for Modern Businesses
              </h2>
              <p className='text-base font-normal text-SlateBlue dark:text-darktext max-w-408'>
                I specialize in building responsive, high-performance websites and applications that help your business stand out online. With attention to detail and modern best practices, every project is delivered with excellence.
              </p>
              ...
              <div className='mt-8'>
                <Link href='/portfolio' className='btn inline-flex items-center gap-3'>
                  View My Work
